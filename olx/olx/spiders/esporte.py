...
db = client['olx']
collection = db['esporte']

class EsporteSpider(scrapy.Spider):
    name = 'esporte'
    allowed_domains = ['am.olx.com.br']
    start_urls = [
        # https://am.olx.com.br/regiao-de-manaus/autos-e-pecas
        # 'https://am.olx.com.br/regiao-de-manaus/autos-e-pecas/esporte-vans-e-utilitarios/gm-chevrolet-s10-h-country-2-8-4x4-diesel-automatica-638029095'
        # 'https://am.olx.com.br/autos-e-pecas/esporte-vans-e-utilitarios/'
        'https://am.olx.com.br/esportes-e-lazer'
        ]
