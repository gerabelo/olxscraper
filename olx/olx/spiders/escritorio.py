...
db = client['olx']
collection = db['escritorio']

class EscritorioSpider(scrapy.Spider):
    name = 'escritorio'
    allowed_domains = ['am.olx.com.br']
    start_urls = [
        # https://am.olx.com.br/regiao-de-manaus/autos-e-pecas
        # 'https://am.olx.com.br/regiao-de-manaus/autos-e-pecas/escritorio-vans-e-utilitarios/gm-chevrolet-s10-h-country-2-8-4x4-diesel-automatica-638029095'
        # 'https://am.olx.com.br/autos-e-pecas/escritorio-vans-e-utilitarios/'
        'https://am.olx.com.br/comercio-e-escritorio'
        ]
