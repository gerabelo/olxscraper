...
db = client['olx']
collection = db['outrascidades']

class OutrascidadesSpider(scrapy.Spider):
    name = 'outrascidades'
    allowed_domains = ['am.olx.com.br']
    start_urls = [
        # https://am.olx.com.br/regiao-de-outrascidades/autos-e-pecas
        # 'https://am.olx.com.br/regiao-de-outrascidades/autos-e-pecas/carros-vans-e-utilitarios/gm-chevrolet-s10-h-country-2-8-4x4-diesel-automatica-638029095'
        'https://am.olx.com.br/regiao-de-manaus/outras-cidades'
        ]
