...
db = client['olx']
collection = db['infantis']

class InfantisSpider(scrapy.Spider):
    name = 'infantis'
    allowed_domains = ['am.olx.com.br']
    start_urls = [
        # https://am.olx.com.br/regiao-de-infantis/autos-e-pecas
        # 'https://am.olx.com.br/regiao-de-infantis/autos-e-pecas/carros-vans-e-utilitarios/gm-chevrolet-s10-h-country-2-8-4x4-diesel-automatica-638029095'
        'https://am.olx.com.br/artigos-infantis'
        ]
