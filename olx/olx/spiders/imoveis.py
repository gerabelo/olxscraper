...
class ImoveisSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # print(price)
        # print(modelo)
        mydoc = {"url":response.request.url,"phone":phone,"location":location,"name":name,"insertedAt":InsertedAt,"collectedIn":today.strftime("%d/%m/%Y"),"model":modelo,"price":price,"description":description,"Olx-id":id_}
